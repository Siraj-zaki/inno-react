...
import SupplyChainASNPackingTable from '../components/SupplyChainASNPackingTable';
import moment from 'moment'
export class SupplyChainIBTDataPacking extends Component {
    state = {
        location: '',
        ASN: [],
        device: '',
                    ...
                    <div className="main-dashboard">
                        ...
                        <div className="dashboard ">
                            <div className="dashboard-header">
                                ...
                                <h1 className="dashboard-heading">IBT Data(Packing)</h1>
                            </div>
                            <Collapse in={this.state.open} timeout="auto" unmountOnExit style={{ width: '100%' }}>
                                <div style={{ width: '100%', display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', backgroundColor: 'transparent' }}>
                                    <form style={{ width: '30%', margin: 20, marginBottom: 0, display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-end', flexWrap: 'wrap', flexDirection: 'column', minHeight: 'auto' }} noValidate={false} autoComplete="off">
                                    ...
                                    <form style={{ width: '30%', margin: 20, marginBottom: 0, display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexWrap: 'wrap', flexDirection: 'column', minHeight: 'auto' }} noValidate={false} autoComplete="off">
                            ...
                            <SupplyChainASNPackingTable asn={this.state.ASN} />
...
export default SupplyChainIBTDataPacking
