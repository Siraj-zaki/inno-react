...
export default function ViewASNDetailByEPCTable({ ibt, perData, loader, openModal, RoleData, deleteRole, zone }) {
                ...
                <Table size="small" aria-label="collapsible table">
                    <TableHead   >
                        <TableRow >
                            ...
                            <TableCell align="center" style={{ color: 'white', fontWeight: 'bold', letterSpacing: 1,  }} >ASN</TableCell>
                            <TableCell align="center" style={{ color: 'white', fontWeight: 'bold', letterSpacing: 1,  }} >Operation</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody >
                        {ibt ? ibt.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                            <React.Fragment>
                                <TableRow >
