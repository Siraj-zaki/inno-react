...
export default function SupplyChainWarehouseSummaryTable({ openModal }) {
                        ...
                        {DevicesData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((device) => {
                            return (
                                <TableRow style={{ backgroundColor: '#263238' }} hover role="checkbox" tabIndex={-1} key={device.Date}>
                                    <React.Fragment>
                                        <TableCell style={{ color: 'white', fontWeight: 'bold', letterSpacing: 1, fontSize: 13, border: '1px solid white', }} align='center'>
                                            {device.Date}
                                        </TableCell>
